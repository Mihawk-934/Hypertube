...
import { providerG, providerT } from '../../../../fire';
import '../../auth.css';
        ...
        return (
            <>
                ...
                <div className="login-social-wrapper">
                    <button className="login-social" onClick={() => this.props.socialAuth(providerT, this.props.history, 'twitter')}>
                    ...
                    <button className="login-social" onClick={() => this.props.socialAuth(providerG, this.props.history, 'gmail')}>
...
const mapDispatchToProps = dispatch => {
    return {
        socialAuth: (provider, history, name) => dispatch(actions.socialAuth(provider, history, name)),
    };
};
